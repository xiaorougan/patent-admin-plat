...
// @Param data body dtos.DeptInsertReq true "时间、部门名称、id"
...
// @Tags 管理员-部门
// @Param DeptId query string false "部门ID"
// @Router /api/v1/admin-agent/dept/join/{dept_id} [put]
// @Security Bearer
...
// @Tags 管理员-部门
// @Param DeptId query string false "部门ID"
// @Router /api/v1/admin-agent/dept/unJoin/{dept_id} [put]
// @Security Bearer
...
// @Tags 管理员-部门
// @Param DeptId query string false "部门ID"
// @Router /api/v1/admin-agent/dept/joinReject/{dept_id} [put]
// @Security Bearer
